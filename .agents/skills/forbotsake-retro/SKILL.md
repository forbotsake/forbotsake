...
description: >
  ...
  Use when: "what worked", "marketing retro", "measure results", "review
  performance",
...
Ask the user directly in conversation to let the user provide publishing history manually.
...
Ask the user directly in conversation for each published piece. Ask ONE piece at a time to keep it manageable.
