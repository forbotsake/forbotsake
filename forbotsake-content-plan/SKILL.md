...
description: |
  Turns your marketing strategy into an executable content calendar. Reads strategy.md,
...
Follow-up question via AskUserQuestion:
...
```bash
_SKILL_DIR=$(dirname "$(find ~/.claude/skills -path "*/forbotsake-content-plan/SKILL.md" -type f 2>/dev/null | head -1)")
