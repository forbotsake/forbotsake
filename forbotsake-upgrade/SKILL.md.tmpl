...
**If `AUTO_UPGRADE=true`:** Skip AskUserQuestion. Log "Auto-upgrading forbotsake..." and proceed to Step 2.
...
```bash
_SKILL_DIR=$(find ~/.claude/skills -path "*/forbotsake-upgrade/SKILL.md" -type f 2>/dev/null | head -1)
